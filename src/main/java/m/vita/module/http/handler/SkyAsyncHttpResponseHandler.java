...
public abstract class JEBAsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    private static final String LOG_TAG = "JEBAsyncHttp";
    ...
    /**
     * Creates a new JEBAsyncHttpResponseHandler
     */
    public JEBAsyncHttpResponseHandler() {
        this(null);
    }

    /**
     * Creates a new JEBAsyncHttpResponseHandler with a user-supplied looper. If
     * the passed looper is null, the looper attached to the current thread will
     * be used.
     *
     * @param looper The looper to work with
     */
    public JEBAsyncHttpResponseHandler(Looper looper) {
    ...
    /**
     * Creates a new JEBAsyncHttpResponseHandler and decide whether the callbacks
     ...
     */
    public JEBAsyncHttpResponseHandler(boolean usePoolThread) {
    ...
    public void setUseSynchronousMode(boolean sync) {
        ...
        if (!sync && looper == null) {
            sync = true;
            JEBAsyncHttpClient.log.w(LOG_TAG, "Current thread has not called Looper.prepare(). Forcing synchronous mode.");
        }
    ...
    public void onProgress(long bytesWritten, long totalSize) {
        JEBAsyncHttpClient.log.v(LOG_TAG, String.format("Progress %d from %d (%2.0f%%)", bytesWritten, totalSize, (totalSize > 0) ? (bytesWritten * 1.0 / totalSize) * 100 : -1));
    }
    ...
    public void onRetry(int retryNo) {
        JEBAsyncHttpClient.log.d(LOG_TAG, String.format("Request retry no. %d", retryNo));
    }

    public void onCancel() {
        JEBAsyncHttpClient.log.d(LOG_TAG, "Request got cancelled");
    }

    public void onUserException(Throwable error) {
        JEBAsyncHttpClient.log.e(LOG_TAG, "User-space exception detected!", error);
            ...
            switch (message.what) {
                case SUCCESS_MESSAGE:
                    ...
                    if (response != null && response.length >= 3) {
                        ...
                        JEBAsyncHttpClient.log.e(LOG_TAG, "SUCCESS_MESSAGE didn't got enough params");
                    }
                    break;
                case FAILURE_MESSAGE:
                    ...
                    if (response != null && response.length >= 4) {
                        ...
                        JEBAsyncHttpClient.log.e(LOG_TAG, "FAILURE_MESSAGE didn't got enough params");
                    }
                    break;
                case START_MESSAGE:
                    onStart();
                ...
                case PROGRESS_MESSAGE:
                    ...
                    if (response != null && response.length >= 2) {
                        try {
                            ...
                            JEBAsyncHttpClient.log.e(LOG_TAG, "custom onProgress contains an error", t);
                        }
                    } else {
                        JEBAsyncHttpClient.log.e(LOG_TAG, "PROGRESS_MESSAGE didn't got enough params");
                    }
                    break;
                case RETRY_MESSAGE:
                    response = (Object[]) message.obj;
                    if (response != null && response.length == 1) {
                        ...
                        JEBAsyncHttpClient.log.e(LOG_TAG, "RETRY_MESSAGE didn't get enough params");
                    }
                    break;
                case CANCEL_MESSAGE:
                    onCancel();
            ...
            if (instream != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        JEBAsyncHttpClient.silentCloseInputStream(instream);
                        JEBAsyncHttpClient.endEntityViaReflection(entity);
                    }
    ...
    private static class ResponderHandler extends Handler {
        private final JEBAsyncHttpResponseHandler mResponder;

        ResponderHandler(JEBAsyncHttpResponseHandler mResponder, Looper looper) {
            super(looper);
