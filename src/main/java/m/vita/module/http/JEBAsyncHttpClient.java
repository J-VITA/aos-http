...
import m.vita.module.http.client.protocol.SyncBasicHttpContext;
...
import m.vita.module.http.cookie.PersistentCookieStore;
import m.vita.module.http.entity.StringEntity;
import m.vita.module.http.exception.HttpException;
import m.vita.module.http.execute.BasicHttpContext;
import m.vita.module.http.factory.PlainSocketFactory;
import m.vita.module.http.factory.SSLSocketFactory;
import m.vita.module.http.factory.SchemeRegistry;
import m.vita.module.http.factory.JEBSSLSocketFactory;
import m.vita.module.http.handler.LogHandler;
import m.vita.module.http.handler.LogInterface;
import m.vita.module.http.handler.RequestHandle;
...
import m.vita.module.http.interceptor.PreemptiveAuthorizationHttpRequestInterceptor;
import m.vita.module.http.method.HttpDelete;
...
import m.vita.module.http.method.HttpPatch;
import m.vita.module.http.method.HttpPost;
import m.vita.module.http.method.HttpPut;
import m.vita.module.http.method.JEBHttpGet;
import m.vita.module.http.params.ClientPNames;
import m.vita.module.http.params.ConnManagerParams;
import m.vita.module.http.params.ConnPerRouteBean;
import m.vita.module.http.params.ConnRoutePNames;
...
public class JEBAsyncHttpClient {
    public static final String LOG_TAG = JEBAsyncHttpClient.class.getSimpleName();
    ...
    /**
     * Creates a new JEBAsyncHttpClient with default constructor arguments values
     */
    public JEBAsyncHttpClient() {
        this(false, 80, 443);
    }

    /**
     * Creates a new JEBAsyncHttpClient.
     *
     * @param httpPort non-standard HTTP-only port
     */
    public JEBAsyncHttpClient(int httpPort) {
     ...
     */
    public JEBAsyncHttpClient(int httpPort, int httpsPort) {
        this(false, httpPort, httpsPort);
    }

    /**
     * Creates new JEBAsyncHttpClient using given params
     *
     * @param fixNoHttpResponseException Whether to fix issue or not, by omitting SSL verification
     * @param httpPort                   HTTP port to be used, must be greater than 0
     * @param httpsPort                  HTTPS port to be used, must be greater than 0
     */
    public JEBAsyncHttpClient(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
     ...
     */
    public JEBAsyncHttpClient(SchemeRegistry schemeRegistry) {
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean fixNoHttpResponseException, int httpPort, int httpsPort) {
        ...
        if (fixNoHttpResponseException) {
            sslSocketFactory = JEBSSLSocketFactory.getFixedSocketFactory();
        } else {
    ...
    /**
     * Will return current LogInterface used in JEBAsyncHttpClient instance
     *
     * @return LogInterface currently used by JEBAsyncHttpClient instance
     */
     ...
     * to be used in JEBAsyncHttpClient instance
     *
    ...
    public void setEnableRedirects(final boolean enableRedirects, final boolean enableRelativeRedirects, final boolean enableCircularRedirects) {
        ...
        httpClient.setRedirectHandler(new JEBRedirectHandler(enableRedirects));
    }
     ...
     * @see JEBRedirectHandler
     */
    public void setRedirectHandler(final JEBRedirectHandler customRedirectHandler) {
    ...
    /**
     * Will, before sending, remove all headers currently present in JEBAsyncHttpClient instance, which
     ...
     * can use call `JEBAsyncHttpClient.addHeader("Authorization","Basic base64OfUsernameAndPassword==")`
     *
    ...
    public RequestHandle get(Context context, String url, HttpEntity entity, String contentType, ResponseHandlerInterface responseHandler) {
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new JEBHttpGet(URI.create(url).normalize()), entity), contentType, responseHandler, context);
    }
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void delete(String url, RequestParams params, JEBAsyncHttpResponseHandler responseHandler) {
     ...
     * @return JEBAsyncHttpRequest ready to be dispatched
     */
    protected JEBAsyncHttpRequest newAsyncHttpRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        return new JEBAsyncHttpRequest(client, httpContext, uriRequest, responseHandler);
    }
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler, Context context) {
        ...
        if (responseHandler.getUseSynchronousMode() && !responseHandler.getUsePoolThread()) {
            throw new IllegalArgumentException("Synchronous ResponseHandler used in JEBAsyncHttpClient. You should create your response handler in a looper thread or use SyncHttpClient instead.");
        }
        ...
        JEBAsyncHttpRequest request = newAsyncHttpRequest(client, httpContext, uriRequest, contentType, responseHandler, context);
    ...
    private static class InflatingEntity extends HttpEntityWrapper {
        ...
        public void consumeContent() throws IOException {
            JEBAsyncHttpClient.silentCloseInputStream(wrappedStream);
            JEBAsyncHttpClient.silentCloseInputStream(pushbackStream);
            JEBAsyncHttpClient.silentCloseInputStream(gzippedStream);
