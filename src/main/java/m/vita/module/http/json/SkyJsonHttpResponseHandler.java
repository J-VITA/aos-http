...
/**
 * Used to intercept and handle the responses from requests made using {@link JEBAsyncHttpClient}, with
 ...
 */
public class JEBJsonHttpResponseHandler extends JEBTextHttpResponseHandler {
     ...
     */
    public JEBJsonHttpResponseHandler() {
        super(JEBAsyncHttpResponseHandler.DEFAULT_CHARSET);
    }
     ...
     */
    public JEBJsonHttpResponseHandler(String encoding) {
        super(encoding);
    }
     ...
     */
    public JEBJsonHttpResponseHandler(boolean useRFC5179CompatibilityMode) {
        super(JEBAsyncHttpResponseHandler.DEFAULT_CHARSET);
     ...
     * @param useRFC5179CompatibilityMode Boolean mode to use RFC5179 or latest
     */
    public JEBJsonHttpResponseHandler(String encoding, boolean useRFC5179CompatibilityMode) {
        super(encoding);
        this.useRFC5179CompatibilityMode = useRFC5179CompatibilityMode;
    }
    ...
    public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
        JEBAsyncHttpClient.log.w(LOG_TAG, "onSuccess(int, Header[], JSONObject) was not overriden, but callback was received");
    }
    ...
    public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
        JEBAsyncHttpClient.log.w(LOG_TAG, "onSuccess(int, Header[], JSONArray) was not overriden, but callback was received");
    }
    ...
    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
        JEBAsyncHttpClient.log.w(LOG_TAG, "onFailure(int, Header[], Throwable, JSONObject) was not overriden, but callback was received", throwable);
    }
    ...
    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONArray errorResponse) {
        JEBAsyncHttpClient.log.w(LOG_TAG, "onFailure(int, Header[], Throwable, JSONArray) was not overriden, but callback was received", throwable);
    }

    @Override
    public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
        JEBAsyncHttpClient.log.w(LOG_TAG, "onFailure(int, Header[], String, Throwable) was not overriden, but callback was received", throwable);
    }

    @Override
    public void onSuccess(int statusCode, Header[] headers, String responseString) {
        JEBAsyncHttpClient.log.w(LOG_TAG, "onSuccess(int, Header[], String) was not overriden, but callback was received");
    }
    ...
    public final void onFailure(final int statusCode, final Header[] headers, final byte[] responseBytes, final Throwable throwable) {
        if (responseBytes != null) {
            ...
            JEBAsyncHttpClient.log.v(LOG_TAG, "response body is null, calling onFailure(Throwable, JSONObject)");
