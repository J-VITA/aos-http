...
public class JEBAMultipartEntity implements HttpEntity {
    private static final String LOG_TAG = "JEBMultipartEntity";
    ...
    public JEBAMultipartEntity(ResponseHandlerInterface progressHandler) {
    ...
    public void addPart(String key, String value, String contentType) {
        try {
            ...
            JEBAsyncHttpClient.log.e(LOG_TAG, "addPart ByteArrayOutputStream exception", e);
        }
    }
    ...
    private byte[] createContentType(String type) {
        String result = JEBAsyncHttpClient.HEADER_CONTENT_TYPE + ": " + normalizeContentType(type) + STR_CR_LF;
        return result.getBytes();
    }

    private byte[] createContentDisposition(String key) {
        return (
                JEBAsyncHttpClient.HEADER_CONTENT_DISPOSITION +
    ...
    private class FilePart {
        ...
        private byte[] createHeader(String key, String filename, String type) {
            ...
            try {
                ...
                JEBAsyncHttpClient.log.e(LOG_TAG, "createHeader ByteArrayOutputStream exception", e);
            }
        ...
        public void writeTo(OutputStream out) throws IOException {
            ...
            out.flush();
            JEBAsyncHttpClient.silentCloseInputStream(inputStream);
        }
    }
}
