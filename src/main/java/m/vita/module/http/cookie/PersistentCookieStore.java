 ...
 * designed to be used with {@link JEBAsyncHttpClient#setCookieStore}, but can also be used with a
...
public class PersistentCookieStore implements CookieStore {
    ...
    protected String encodeCookie(SerializableCookie cookie) {
        ...
        try {
            ...
            JEBAsyncHttpClient.log.d(LOG_TAG, "IOException in encodeCookie", e);
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            JEBAsyncHttpClient.log.d(LOG_TAG, "IOException in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            JEBAsyncHttpClient.log.d(LOG_TAG, "ClassNotFoundException in decodeCookie", e);
        }
